...
public class Vr88Ma : MonoBehaviour {
    [DllImport("pc8801ma")] private static extern IntPtr Init();
    [DllImport("pc8801ma")] private static extern void Exec();
    [DllImport("pc8801ma")] private static extern void StopEmulation();
    [DllImport("pc8801ma")] private static extern void EmulKeyUp(int keyCode);
    [DllImport("pc8801ma")] private static extern void EmulKeyDown(int keyCode);
    [DllImport("pc8801ma")] private static extern IntPtr CheckResident();
    [DllImport("pc8801ma")] private static extern int GetEmulWidth(IntPtr ptr);
    [DllImport("pc8801ma")] private static extern int GetEmulHeight(IntPtr ptr);
    [DllImport("pc8801ma")] private static extern void SetEmulTexturePtr(IntPtr ptr, IntPtr texture);
    [DllImport("pc8801ma")] private static extern void SetEmulPause(IntPtr ptr, bool fPause);
    [DllImport("pc8801ma")] private static extern IntPtr GetRenderEventFunc();
    [DllImport("pc8801ma")] private static extern void EmuSendAudio(float[] data, int sz, int ch);
    [DllImport("pc8801ma", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
    ...
    void Start() {
        ...
        var driveA = Path.GetFullPath(Path.Combine(Application.streamingAssetsPath, "Vr88MaA.D88"));
        var driveB = Path.GetFullPath(Path.Combine(Application.streamingAssetsPath, "Vr88MaB.D88"));
    ...
    void OnDisable() {
        ...
        Debug.Log("**Disable:Pause On");       // �G�f�B�^�ł̒�~
    ...
    void OnEnable() {
        ...
        Debug.Log("**Enable:Pause Off");       // �G�f�B�^�ł̍ĊJ
        SetEmulPause(_emul, false);
    }
